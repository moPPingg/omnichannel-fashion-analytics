...
LOAD_ORDER = [
    ...
    ("supply", "goods_receipts"),
    ("supply", "quality_checks"),
]

DELETE_ORDER = list(reversed(LOAD_ORDER))

DATE_COLUMNS = {
    "purchase_orders": ["po_date", "planned_delivery_date"],
    "goods_receipts": ["receipt_date", "actual_delivery_date"],
...
def main() -> None:
    ...
    logger.info("Purchase supply load completed successfully.")
