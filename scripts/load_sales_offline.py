...
LOAD_ORDER = [
    ("sales_offline", "store_orders"),
    ("sales_offline", "store_order_items"),
    ("sales_offline", "store_payments"),
]

DELETE_ORDER = list(reversed(LOAD_ORDER))

DATETIME_COLUMNS = {
    "store_orders": ["order_datetime"],
    "store_payments": ["payment_datetime"],
}
...
def main() -> None:
    ...
    logger.info("Offline sales load completed successfully.")
